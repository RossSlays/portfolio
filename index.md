...
hero:
  ...
  tagline: I've been building for the web since 2015 and now lead a digital department pushing into emerging technology. I combine bespoke code, an obsession with accessibility and a talent for turning technical complexity into plain English to build digital experiences that feel personal and function flawlessly.
  image:
    src: /photo.webp
    alt: Ross Hayes
  actions:
